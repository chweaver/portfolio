...
import { HeroCertRoadmap } from './HeroCertRoadmap';

const STATS = [
  { label: 'Subnets routed', value: '2', sub: 'LAN + LAB200' },
  { label: 'Firewall rules', value: '3', sub: 'pass / block / pass' },
  { label: 'Lab VMs', value: '7', sub: 'pfSense + 2 Windows + 4 Linux' },
];
  ...
  return (
    <section id="top" className="scroll-mt-40 relative pt-14 pb-14 md:pt-20 md:pb-20">
      <div className="container-narrow relative">
        {/* Top: narrative on the left, cert roadmap on the right (desktop). */}
        <div className="grid gap-x-10 gap-y-12 lg:grid-cols-[1.5fr_1fr] lg:items-center">
          <div className="min-w-0">
            ...
            <div className="mt-8 grid grid-cols-2 gap-px overflow-hidden rounded-xl border border-bg-border bg-bg-border">
              {heroGlance.map((g) => (
          ...
          {/* Right: mini cert roadmap toward network engineering. */}
          <div className="min-w-0">
            <HeroCertRoadmap />
          </div>
        </div>
