...
const siteDescription = `Entry-level MSP candidate. Live Active Directory domain, routed pfSense lab, CompTIA A+ certified, documented and verified. No professional MSP tenure yet.`;
